...
var logger logSys
var isQuickSave bool

func InitLog(level int, _isQuickSave bool) bool {

	//TODO: add log adjust
	logger.logLevel = level
	logger.initFiles()
	isQuickSave = _isQuickSave
	return true
}
...
func (l *logSys) genHeader(level int) (buf *buffer, err error) {
	...
	//header += "[" + time.Now().Format("Jan 2, 2006 at 3:04pm (MST)") + " "
	header += "[" + time.Now().Format("3:04:05") + " "
